[rewrite_local]
# 广告
^https?:\/\/(api|jmtp)(.*-uat)?\.\w+\.com\/v2.5\/(bootstrap|user\/login|user\/avatarFrame|article\/discovery|navigation|ad\/space|my\/userExtraInfo) url script-response-body https://raw.githubusercontent.com/YeJoe/Jsdelivr-CDN/refs/heads/main/one.js
# 解锁
^https?:\/\/(api|jmtp)(.*-uat)?\.\w+\.com\/v2.5\/(article\/detail) url script-request-header https://raw.githubusercontent.com/YeJoe/Jsdelivr-CDN/refs/heads/main/one.js
